...
export type Model = {
  ...
  gallery?: string[];         // 0–3 photo paths for the model gallery, e.g. ['/images/gallery/balance-7-1.jpg', ...]
...
export const series: Series[] = [
  {
    ...
    models: [
      ...
      },
      {
        ...
        gallery: ['/images/gallery/lsx-800-1.jpg', '/images/gallery/lsx-800-2.jpg', '/images/gallery/lsx-800-3.jpg'],
      ...
      },
      {
        ...
        gallery: ['/images/gallery/lsx-900-1.jpg', '/images/gallery/lsx-900-2.jpg', '/images/gallery/lsx-900-3.jpg'],
  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        ...
        gallery: ['/images/gallery/ts-8-2-1.jpg', '/images/gallery/ts-8-2-2.jpg', '/images/gallery/ts-8-2-3.jpg'],
      ...
      },
      {
        ...
        gallery: ['/images/gallery/ts-7-25-1.jpg'],
      ...
      },
      {
        ...
        image: '/images/model-ts-67-25.jpg',
            ...
            gallery: ['/images/gallery/ts-67-25-1.jpg', '/images/gallery/ts-67-25-2.jpg', '/images/gallery/ts-67-25-3.jpg'],
      ...
      },
      {
        ...
        gallery: ['/images/gallery/ts-240x-1.jpg', '/images/gallery/ts-240x-2.jpg', '/images/gallery/ts-240x-3.jpg'],
  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        ...
        gallery: ['/images/gallery/balance-7-1.jpg', '/images/gallery/balance-7-2.jpg', '/images/gallery/balance-7-3.jpg'],
    ...
    models: [
      {
        ...
        gallery: ['/images/gallery/l7-1.jpg', '/images/gallery/l7-2.jpg', '/images/gallery/l7-3.jpg'],
      ...
      },
      {
        ...
        gallery: ['/images/gallery/l6-1.jpg', '/images/gallery/l6-2.jpg', '/images/gallery/l6-3.jpg'],
    ...
    models: [
      {
        ...
        gallery: ['/images/gallery/bar-harbor-1.jpg', '/images/gallery/bar-harbor-2.jpg', '/images/gallery/bar-harbor-3.jpg'],
      ...
      },
      {
        ...
        gallery: ['/images/gallery/ocho-rios-1.jpg', '/images/gallery/ocho-rios-2.jpg', '/images/gallery/ocho-rios-3.jpg'],
      ...
      },
      {
        ...
        gallery: ['/images/gallery/san-miguel-1.jpg', '/images/gallery/san-miguel-2.jpg', '/images/gallery/san-miguel-3.jpg'],
